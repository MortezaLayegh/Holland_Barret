...
#             Customer_ID = request.form['Customer_ID']  # This is the corrected line
...
# 			'Loyalty Points'] 
#             data = [Transaction_ID , Customer_ID , Date , Total_Items , Unique_Items , Total_Sales , Discounted_Sales , Browsing_Duration_minutes ,
#                     Number_of_Clicks,Age,Gender, Region, Marital_Status, Education, Household_Income, Loyalty_Card, Loyalty_Points]
